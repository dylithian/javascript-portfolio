  ...
  _createClass(Card, [{
    ...
    value: function render() {
      return /*#__PURE__*/_react["default"].createElement("div", {
        className: "".concat(_backgroundModule["default"].white, " ").concat(_layoutModule["default"].slightPadding, " ").concat(_layoutModule["default"].shadowAsCard, " ").concat(_layoutModule["default"].standardCard)
      }, this.props.children);
    }
  }]);
